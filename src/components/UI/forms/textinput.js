	...
	render(){
		return (
			<div className={"form-group form-md-line-input " + ((this.props.data.error && this.props.data.touched) ? 'has-error' : '')}>
                <input type={this.props.type} className="form-control" id="form_control_1" _{...this.props.data} placeholder={this.props.placeholder ? this.props.placeholder : this.props.name} />
